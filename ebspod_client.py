...
if __name__ == '__main__':
    ...
    #system("ffmpeg -i %s %s" % (flv_file, mp3_file))
    system("rtmpdump -r rtmp://ebsandroid.ebs.co.kr/fmradiofamilypc/familypc1m -B %d -o - | avconv -i - -b 64k %s" % (int(sys.argv[1])*60, mp3_file))
...
#    mp3_file = 'test.mp3'
    ...
    params = urllib.urlencode(
            {'program_name': program_name, 'title': title.encode('utf-8'), 'title': title.encode('utf-8'), 'file_url': s3_url(title).encode('utf-8'),
